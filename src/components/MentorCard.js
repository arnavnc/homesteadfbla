...
import Aaron from "../../public/static/officers/Aaron.JPG"
import Alessandro from "../../public/static/officers/Alessandro.JPG"
...
export default function MentorCard({ name, type, competition, desc, image }) {
    return (
        <div class="md:flex bg-white bg-opacity-5 rounded-xl p-8 md:p-0">
            <Image draggable={false} width={300} height={1000} src={Aaron} alt="" class="h-48 max-w-48 object-cover object-top opacity-50 rounded-l-lg rounded-r-lg md:rounded-r-none mx-auto"/>
