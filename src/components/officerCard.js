    ...
    return (
        <figure class="md:flex bg-white bg-opacity-5 rounded-xl p-8 md:p-0">
            <div class="pt-6 md:p-8 text-center md:text-left space-y-4 h-fit">
                <Image draggable={false} width={500} height={500} src={`/static/officers/${image}.JPG`} alt="" class="object-cover object-top h-96 opacity-75 rounded-l-lg rounded-r-lg mx-auto"/>
