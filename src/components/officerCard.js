...
export default function OfficerCard({ name, position, bio, quote, image }) {
    return (
        <figure class="md:flex bg-white bg-opacity-5 rounded-xl p-8 md:p-0">
            ...
            <Image draggable={false} width={500} height={500} src={`/static/faces/${image}.png`} alt="" class="object-cover object-top h-96 opacity-75 rounded-l-lg rounded-r-lg mx-auto"/>
